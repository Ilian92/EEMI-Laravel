        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <p class="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
                    La plateforme premium dédiée aux passionnés de pieds. Découvrez du contenu exclusif créé par les
                    meilleurs créateurs.
                </p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <p class="text-gray-600">Accédez à du contenu premium créé spécialement pour notre communauté
                        passionnée.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-gray-600">Rejoignez une communauté bienveillante de créateurs et d'amateurs
                        partageant votre passion.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-gray-600">Votre confidentialité est notre priorité. Profitez d'un environnement sûr
                        et discret.</p>
                </div>
            </div>
        </div>
    ...
    <section class="bg-gradient-to-br from-blue-100 to-indigo-100 py-20">
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                    Les meilleurs créateurs & leurs derniers posts
                </h2>
                <p class="text-xl text-gray-600 max-w-2xl mx-auto">
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                <div>
                    <div class="text-3xl md:text-4xl font-bold mb-2" style="color: #00aff0;">
